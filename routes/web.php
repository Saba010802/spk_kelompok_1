...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('setup')->group(function () {
        ...
        Route::get('/siswa/add', [SiswaController::class, 'AddSiswa'])->name('add.siswa');
        Route::post('/siswa/store', [SiswaController::class, 'StoreSiswa'])->name('store.data.siswa');
        Route::get('/siswa/edit/{id}', [SiswaController::class, 'EditSiswa'])->name('data.siswa.edit');
        Route::post('/siswa/update/{id}', [SiswaController::class, 'UpdateSiswa'])->name('update.data.siswa');
        Route::get('/siswa/delete/{id}', [SiswaController::class, 'DeleteSiswa'])->name('data.siswa.delete');

        //nilai mapel siswa & keaktifan
        Route::get('/nilai/siswa/view', [NilaiSiswaController::class, 'ViewNilai'])->name('nilai.siswa.view');
        Route::get('/nilai/siswa/add', [NilaiSiswaController::class, 'AddNilai'])->name('add.nilai.siswa');
    ...
    Route::prefix('employees')->group(function () {
        ...
        //view employees monthly salary All route
